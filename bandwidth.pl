...
$sth1 = $dbh->prepare("UPDATE `int_speed` SET iface='$interface',kbitrx='$kbitrx',kbittx='$kbittx',kbitpsrx='$kbitpsrx',kbitpstx='
$kbitpstx'  WHERE id='$id'");# request
$sth1->execute;
