...
echo "<tr>
      <td>"."$line[id] | 
      </td><td> Chan <b><font color=\"yellow\">$line[name]</font></b> \\$line[link]
      </td><td> speed <b>$line[speed]</b> Kbit\s <a href=\"../screen/$line[id].jpg\" target=\"_blank\">screen</a>|  
      </td><td> <b>$time</b> min ago. "."</td>
      </tr>";
}
if($line[speed] < $sens and $line[speed] != 00000){
echo "<tr>
      <td>"."$line[id] | 
      </td><td> Chan <b><font color=\"red\">$line[name]</font></b>\\$line[link]
      </td><td> speed <b>$line[speed]</b> Kbit\s <a href=\"../screen/$line[id].jpg\" target=\"_blank\">screen</a>|
      </td><td><b>$time</b> min ago. "."</td>
      </tr>";
}
...
echo "<tr><td>"."$line[id] | 
      </td><td> Chan <b><font color=\"green\">$line[name]</font></b>\\$line[link]
      </td><td> speed <b>$line[speed]</b> Kbit\s <a href=\"../screen/$line[id].jpg\" target=\"_blank\">screen</a>|
      </td><td><b>$time</b> min ago."."</td>
      </tr>";
 }
