...
echo "$line[id] Chan <b><font color=\"red\">$line[name]</font></b>\\$line[link] speed <b>$line[speed]</b> Kbit\s <a href=\"../screen/$id.jpg\" target=\"_blank\">screen</a>|<b>$time</b> min ago. <br>";
}
if($line[speed] != 00000 and $line[speed] > $sens){
echo "$line[id] Chan <b><font color=\"green\">$line[name]</font></b>\\$line[link] speed <b>$line[speed]</b> Kbit\s <a href=\"../screen/$id.jpg\" target=\"_blank\">screen</a>|<b>$time</b> min ago.<br>";
 }
}
?>
